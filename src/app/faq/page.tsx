            ...
            <Accordion className="w-full space-y-4">
              ...
              >
                ...
                <AccordionContent className="text-slate-600 mt-2 space-y-2 text-sm leading-relaxed">
                  <p>
                    Nous proposons des formations en conduite (permis B, A, C,
                    CE, D), en transport routier (FIMO, FCO), ainsi qu&apos;en
              ...
              >
                ...
                <AccordionContent className="text-slate-600 mt-2 space-y-2 text-sm leading-relaxed">
                  ...
                  <p>
                    ...
                    financement. Nous vous invitons à consulter nos CGV et à
                    nous contacter rapidement afin que nous trouvions avec vous
