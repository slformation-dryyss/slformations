      ...
      <main className="pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-8 text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">2. Produits et Services</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">4. Accès aux Formations</h2>
              <p>
