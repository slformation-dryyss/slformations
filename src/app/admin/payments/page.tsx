            ...
            AND: [
                ...
                query ? {
                    OR: [
                        ...
                        { adminNote: { contains: query, mode: "insensitive" } }
                    ]
                } : {}
            ]
        },
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-sm flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-black text-slate-900">{payments.filter(p => p.method === "STRIPE").length}</p>
                    </div>
                </div>
                <div className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-sm flex items-center gap-5">
                    <div className="w-14 h-14 bg-slate-50 rounded-2xl flex items-center justify-center">
                                ...
                                <tr key={p.id} className="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    <td className="px-8 py-5">
                                        <div className="flex items-center gap-2">
                                            {p.method === "STRIPE" ? <CreditCard className="w-3 h-3 text-blue-500" /> : <Banknote className="w-3 h-3 text-gold-500" />}
                                            <span className="text-xs font-black text-slate-900 uppercase">{p.method}</span>
                                        </div>
                                    </td>
