...
import { REQUIRED_DOCS, OPTIONAL_DOCS } from "@/app/dashboard/documents/constants";
                    ...
                    {user.documents.map(doc => (
                        <div key={doc.id} className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className={`text-xs px-2 py-1 rounded font-bold ${doc.status === 'APPROVED' ? 'bg-green-100 text-green-800' :
