...
export function DashboardLayoutClient({
  ...
  return (
    <div className="flex bg-gray-50 min-h-screen font-sans text-slate-900 overflow-x-hidden">
      {/* Sidebar - Handles its own mobile visibility via 'isOpen' and 'md:translate-x-0' */}
      <StudentSidebar 
        role={userRole} 
        roles={userRoles} 
